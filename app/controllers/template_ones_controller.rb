class TemplateOnesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to template_ones_path, status: :see_other, notice: "Template one was successfully destroyed." }
  ...
  private
    ...
    def set_template_one
      @template_one = TemplateOne.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def template_one_params
      params.expect(template_one: [ :string_input_1 ])
    end
end
